package io.github.melvincabatuan.denoising;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    public native void process(Bitmap pTarget, byte[] pSource, float h);

    private Runnable DoImageProcessing = new Runnable() {
        public void run() {
            bProcessing = true;
            process(imageA, videoSource, h);
            imViewA.invalidate();
